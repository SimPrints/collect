 ...
 */
public class SimprintsWidget extends QuestionWidget implements IBinaryWidget {
    ...
    private int request; // which Simprints functionality is requested

    protected EditText mAnswer;

    public SimprintsWidget(Context context, FormEntryPrompt prompt) {
        ...
        String exSpec = prompt.getAppearanceHint().replaceFirst("^simprints[:]", "");
        String function = ExternalAppsUtils.extractIntentName(exSpec);
        switch( function ){
            case "REGISTER":
                request = FormEntryActivity.SIMPRINTS_REGISTRATION;
                break;
            case "IDENTIFY":
                request = FormEntryActivity.SIMPRINTS_IDENTIFY;
                break;
            default:
                request = -1;
                break;
        }
        final String intentName = "com.simprints.id." + function;
        ...
        mLaunchIntentButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Log.i( t, String.format("intent %s, extras %s", i.getAction(), i.getExtras().toString()));
            ...
            private void onException(String toastText) {
                ...
                Toast.makeText(getContext(),
                        ...
                        .show();
                SimprintsWidget.this.mAnswer.requestFocus();
            }
        });
    ...
    protected void fireActivity(Intent i) throws ActivityNotFoundException {
        ...
        ((Activity) getContext()).startActivityForResult(i, request);
    }
